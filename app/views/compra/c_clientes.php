...
<input type="hidden" id="ruta_registro_cliente" value="<?= $ruta_registro_cliente?>">
<input type="hidden" id="ruta_validar_cedula" value="<?= $ruta_validar_cedula?>">
<input type="hidden" id="ruta_buscar_cliente" value="<?= $ruta_buscar_cliente?>">
<input type="hidden" id="ruta_detalle_cliente" value="<?= $ruta_detalle_cliente?>">
<input type="hidden" id="ruta_actualizar_cliente" value="<?= $ruta_actualizar_cliente?>">
